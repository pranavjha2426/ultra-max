...
PM_START_TEXT = """
Hi {}, my name is {}! 
Devloped by @pranavjha1. Feel free to add me to your groups. 
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "Ultra max is now online. I will keep groups safe from spammers,scammer etc 😎😀😎😀😉!")
        except Unauthorized:
            LOGGER.warning(
